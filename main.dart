...
import 'package:manish_app/questions.dart';
...
class _QuizAppState extends State<QuizApp> {
  ...
  Widget _quizStatus() {
    return SingleChildScrollView(
      ...
      child: Row(
          children:
              Iterable<int>.generate(_test.quesList.length).toList().map((idx) {
        if (_test.quesList[idx].getStatus() == null)
          return Container(
            color: _test.index == idx ? Colors.yellow : null,
            child: IconButton(
              icon: Icon(Icons.check_box_outline_blank,
                  color: Color.fromARGB(255, 1, 5, 37), size: 38.0),
  ...
  Widget _quizComplete() {
    return Column(
      ...
      children: <Widget>[
        Material(
          color: Color.fromARGB(255, 181, 231, 45),
          elevation: 50,
          child: Container(
            height: 200,
            width: 350,
      ...
      children: <Widget>[
        ...
        ElevatedButton(
          onPressed: () => setState(() {
            ...
            if (_test.index == _test.quesList.length) _test.index--;
          }),
          child: const Text(
            'True',
          ...
          style: ButtonStyle(
            ...
            padding: MaterialStateProperty.all<EdgeInsetsGeometry>(
                EdgeInsets.fromLTRB(70, 40, 70, 40)),
          ),
        ),
        SizedBox(
          height: 40.0,
        ...
        ElevatedButton(
          ...
          style: ButtonStyle(
            backgroundColor:
                MaterialStateProperty.all<Color>(Color(0xFFE83651)),
            elevation: MaterialStateProperty.all<double>(20.0),
            padding: MaterialStateProperty.all<EdgeInsetsGeometry>(
                EdgeInsets.fromLTRB(70, 40, 70, 40)),
          ),
